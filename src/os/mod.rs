...
#[cfg(target_os = "solaris")] pub use self::sunos as target;
#[cfg(target_os = "illumos")] pub use self::sunos as target;
...
#[cfg(target_os = "solaris")] pub mod sunos;
#[cfg(target_os = "illumos")] pub mod sunos;
